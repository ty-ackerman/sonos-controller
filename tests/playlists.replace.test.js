...
describe('Spotify playlist launch autogroup', () => {
  let app;
  let cleanup;
  ...
  test('autogroups all players before loading playlist metadata', async () => {
    const initialSnapshot = {
      groups: [{ id: 'GID:123', name: 'All Rooms' }],
      players: [
        { id: 'RINCON_A', groupId: 'GID:Other', name: 'Living Room' },
    ...
    const finalSnapshot = {
      groups: [{ id: 'GID:123', name: 'All Rooms' }],
      players: [
        { id: 'RINCON_A', groupId: 'GID:123', name: 'Living Room' },
        { id: 'RINCON_B', groupId: 'GID:123', name: 'Bedroom' }
      ]
    };
